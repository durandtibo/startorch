...
class TimeSequenceGenerator(BaseWrapperSequenceGenerator):
    r"""Implements a sequence creator to generate time sequences.
    ...
    def create_exponential_constant_time_diff(cls, rate: float = 1.0) -> TimeSequenceGenerator:
        r"""Generates a time sequence creator where the time difference
        ...
        Returns:
            ``TimeSequenceGenerator``: A time sequence creator where
    ...
    def create_exponential_time_diff(cls, rate: float = 1.0) -> TimeSequenceGenerator:
        ...
        Returns:
            ``TimeSequenceGenerator``: A time sequence creator where the
    ...
    def create_uniform_time(
        ...
        r"""Generates a time sequence creator where the time is sampled
